# This Makefile is for the MooseX::Notification extension to perl.
#
...
#     DIR => []
#     DISTNAME => q[MooseX-Notification]
#     NAME => q[MooseX::Notification]
#     NO_META => q[1]
#     PL_FILES => {  }
...
MAKE = make
FULLEXT = MooseX/Notification
BASEEXT = Notification
PARENT_NAME = MooseX
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/MooseX/Notification.pm
...
TO_INST_PM = lib/.DS_Store \
	lib/MooseX/Notification.pm

PM_TO_BLIB = lib/MooseX/Notification.pm \
	blib/lib/MooseX/Notification.pm \
	lib/.DS_Store \
	blib/lib/.DS_Store
...
DISTNAME = MooseX-Notification
DISTVNAME = MooseX-Notification-0.0.2
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/MooseX/Notification.pm $(INST_MAN3DIR)/MooseX::Notification.$(MAN3EXT) 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/MooseX/Notification.pm blib/lib/MooseX/Notification.pm \
